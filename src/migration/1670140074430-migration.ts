...
export class migration1670140074430 implements MigrationInterface {
    name = 'migration1670140074430'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_4e03ab28eb389a49b5179ac6002" FOREIGN KEY ("videoId") REFERENCES "video"("id") ON DELETE CASCADE ON UPDATE CASCADE
        `);
        await queryRunner.query(`
            ALTER TABLE "video_tags_tag"
            ADD CONSTRAINT "FK_cfacd951e1dee14c179c7272059" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE CASCADE
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_cfacd951e1dee14c179c727205"
        `);
        await queryRunner.query(`
            DROP INDEX "public"."IDX_4e03ab28eb389a49b5179ac600"
        `);
        await queryRunner.query(`
